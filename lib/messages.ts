...
Come taste the difference.`,
    ...
    beans: {
      ...
      carouselPrev: "Previous coffees",
      carouselNext: "Next coffees",
    ...
    bookForm: {
      ...
      coffeeUnavailableBadge: "Unavailable",
      coffeeCupLiveCounts:
    ...
    admin: {
      coffeeCapsTitle: "Coffee tasting caps",
      coffeeCapsHelp:
        "Maximum cups per lot for this event (database). Use 0 to disable new bookings for a coffee. Changing caps does not edit catalog copy in the repo.",
      maxCupsLabel: "Max cups",
      bookedLabel: "Booked",
      remainingLabel: "Remaining",
      save: "Save",
      saving: "Saving…",
      capsLoadError: "Could not load cup caps.",
...
不信？来试试。`,
    ...
    admin: {
      coffeeCapsTitle: "品鉴杯数上限",
      coffeeCapsHelp:
        "每场活动各款咖啡的最大杯数（数据库）。填 0 可停止接受该款的新预约。修改上限不会改动仓库里的咖啡文案。",
      maxCupsLabel: "上限",
      bookedLabel: "已订",
      remainingLabel: "剩余",
      save: "保存",
      saving: "保存中…",
      capsLoadError: "无法加载杯数上限。",
      saveFailed: "保存失败。",
    },
  },
} as const;
